...
import { FaAward, FaUniversity, FaUserGraduate, FaChalkboardTeacher, FaPlus } from 'react-icons/fa';
      ...
      {showRegistration ? (
        ...
        >
          ...
          <motion.button
            ...
            className="mb-8 flex items-center justify-center mx-auto bg-green-600 hover:bg-green-700 text-white font-medium py-3 px-6 rounded-lg transition-colors duration-200"
          >
